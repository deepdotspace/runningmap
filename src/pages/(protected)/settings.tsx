/**
 * Settings — the signed-in user's account page (name, email, sign out). Reached
 * at /settings; no auth logic lives here because (protected)/_layout.tsx already
 * wraps the subtree in <AuthGate>.
 */
